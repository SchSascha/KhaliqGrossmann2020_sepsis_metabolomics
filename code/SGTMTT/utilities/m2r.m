...
%
% Function call:	cXcYcZ = gtm_m2r(X, Y, Z)
%		            cXcYcZ = gtm_m2r(X, Y)
%		            cXcYcZ = gtm_m2r(X)
%
% Input args.:	X, Y, Z -	mesh-matrices for x-, y- and z- coordinates 
%				            respectively; M-by-N.
%
% Output args.:	cXcYcZ -	matrix of rows of tuples; (M*N)-by-k, where 
%				            k is 1, 2 or 3 (corresponding to 1D, 2D, or 3D)
%
% See also:	gtm_r2m
%
